...
write.table(y, "D://CD/Projet_DSM/Quantile_Regression_Forest/results/results_dataframe/qrfpi_result_ph.csv", row.names=FALSE)
write.table(result, "D://CD/Projet_DSM/Quantile_Regression_Forest/results/results_dataframe/qrf_result_ph.csv", row.names=FALSE)
